...
import { School, Home, Sparkles, BookOpen, User, Heart, ArrowRight, ArrowLeft } from 'lucide-react';
            ...
            <div className="bg-white/90 backdrop-blur-2xl rounded-[4rem] p-12 shadow-2xl border border-white">
              ...
              <div className="space-y-6">
                <div className="group">
                  ...
                  <div className="bg-gray-50 rounded-[2rem] p-5 border-2 border-transparent focus-within:border-orange-200 transition-all">
                    <input 
                      type="text"
                      value={sName}
                ...
                <div className="group">
                  <label className="text-[10px] font-black uppercase tracking-widest text-gray-400 ml-6 mb-2 block">家长姓名</label>
                  <div className="bg-gray-50 rounded-[2rem] p-5 border-2 border-transparent focus-within:border-orange-200 transition-all">
                    <input 
                      type="text"
                      value={pName}
